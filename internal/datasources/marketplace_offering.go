...
var marketplaceofferingplans_componentsAttrTypes = map[string]attr.Type{
	"amount":             types.Int64Type,
	"discount_rate":      types.Int64Type,
	"discount_threshold": types.Int64Type,
	"future_price":       types.StringType,
...
var marketplaceofferingplans_componentsObjectType = types.ObjectType{
	AttrTypes: marketplaceofferingplans_componentsAttrTypes,
}

var marketplaceofferingplans_organization_groupsAttrTypes = map[string]attr.Type{
	"customers_count": types.Int64Type,
	"name":            types.StringType,
	"parent":          types.StringType,
	"parent_name":     types.StringType,
...
var marketplaceofferingplans_organization_groupsObjectType = types.ObjectType{
	AttrTypes: marketplaceofferingplans_organization_groupsAttrTypes,
}

var marketplaceoffering_promotion_campaignsAttrTypes = map[string]attr.Type{
	"description":      types.StringType,
...
var marketplaceoffering_promotion_campaignsObjectType = types.ObjectType{
	AttrTypes: marketplaceoffering_promotion_campaignsAttrTypes,
}
...
func (d *MarketplaceOfferingDataSource) mapResponseToModel(ctx context.Context, apiResp MarketplaceOfferingApiResponse, model *MarketplaceOfferingDataSourceModel) diag.Diagnostics {
	...
	listValPromotionCampaigns, listDiagsPromotionCampaigns := types.ListValueFrom(ctx, marketplaceoffering_promotion_campaignsObjectType, apiResp.PromotionCampaigns)

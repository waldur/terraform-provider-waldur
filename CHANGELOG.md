...
- `marketplace_offering`: attribute `software_catalogs.enabled_cpu_family` type changed from `types.List<string>` to `types.Map`
- `marketplace_offering`: attribute `software_catalogs.enabled_cpu_microarchitectures` type changed from `types.List<string>` to `types.Map`
- `marketplace_offering`: removed attribute `default_access_subnets`
- `marketplace_offering`: removed attribute `open_for_proposals`
...
- `marketplace_offering`: removed attribute `plugin_options.enable_resource_end_date_change_requests`
...
- `marketplace_offering`: removed attribute `plugin_options.show_ssh_key_loss_warning`
- `marketplace_offering`: removed attribute `plugin_options.uid_source`
- `marketplace_offering`: removed attribute `qos_profiles`
- `marketplace_order`: removed attribute `consumer_message_updated_at`
...
- `marketplace_order`: removed attribute `provider_message_updated_at`
- `marketplace_resource`: removed attribute `has_api_keys`
- `marketplace_resource`: removed attribute `order_in_progress.consumer_message_updated_at`
...
- `marketplace_resource`: removed attribute `order_in_progress.provider_message_updated_at`

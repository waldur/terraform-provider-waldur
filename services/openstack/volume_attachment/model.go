...
func (m *OpenstackVolumeAttachmentFiltersModel) GetSchema() schema.SingleNestedAttribute {
	return schema.SingleNestedAttribute{
		Optional:            true,
		MarkdownDescription: "Filter parameters for querying Openstack Volume Attachment",
...
func (model *OpenstackVolumeAttachmentModel) CopyFrom(ctx context.Context, apiResp OpenstackVolumeAttachmentResponse) diag.Diagnostics {

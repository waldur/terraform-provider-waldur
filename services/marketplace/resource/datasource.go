...
func (d *MarketplaceResourceDataSource) mapResponseToModel(ctx context.Context, apiResp MarketplaceResourceResponse, model *MarketplaceResourceDataSourceModel) diag.Diagnostics {
